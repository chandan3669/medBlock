...
export const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center px-4 relative overflow-hidden">
            {/* Background orbs */}
            <div className="absolute -top-40 -left-40 w-[500px] h-[500px] rounded-full bg-violet-600/15 blur-[100px] pointer-events-none" />
            <div className="absolute -bottom-40 -right-20 w-[400px] h-[400px] rounded-full bg-cyan-600/15 blur-[100px] pointer-events-none" />
            ...
            <div className="w-full max-w-md bg-slate-900/80 backdrop-blur-sm border border-slate-800 rounded-2xl p-8 shadow-2xl shadow-black/40">
                ...
                <p className="text-slate-400 text-sm mb-8">Sign in to your MedBlock account</p>
